...
import sircle from '@assets/hero/circle.svg';
import top from '@assets/hero/top.png';
...
const HeroCountdown = ({ days = 0, hours = 0, minutes = 0, seconds = 0 }) => {
  ...
  return (
    <div className={styles.hero_right}>
      <img src={sircle} className="conBg" alt="Sircle" />
      <img src={top} className={styles.hero_top} alt="Top" />
